...
|----------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------|
| `{service}.{region}.byteplusapi.com` <br> 例如：云服务ecs在cn-beijing-autodriving Region域名为： `ecs.cn-beijing-autodriving.byteplusapi.com` | `{service}.byteplusapi.com` <br> 例如：访问控制iam为Global服务，域名为：`iam.byteplusapi.com` |
