...
class AccountDBPrivilegeForCreateDBAccountInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AccountDBPrivilegeForCreateDBAccountInput';
