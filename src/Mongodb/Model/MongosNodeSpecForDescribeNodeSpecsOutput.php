...
class MongosNodeSpecForDescribeNodeSpecsOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'MongosNodeSpecForDescribeNodeSpecsOutput';
