...
class NodeAvailabilityZoneForCreateDBInstanceInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'NodeAvailabilityZoneForCreateDBInstanceInput';
