...
class NodeAvailabilityZoneForRestoreToNewInstanceInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'NodeAvailabilityZoneForRestoreToNewInstanceInput';
