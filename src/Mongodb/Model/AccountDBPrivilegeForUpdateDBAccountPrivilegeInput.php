...
class AccountDBPrivilegeForUpdateDBAccountPrivilegeInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AccountDBPrivilegeForUpdateDBAccountPrivilegeInput';
