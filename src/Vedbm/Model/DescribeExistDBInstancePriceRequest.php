...
class DescribeExistDBInstancePriceRequest implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'charge_type' => 'string',
        'instances' => '\Byteplus\Vedbm\Model\InstanceForDescribeExistDBInstancePriceInput[]',
        'period' => 'int',
        'period_unit' => 'string',
        'user_action' => 'string'
    ];
     ...
     * Gets instances
     *
     * @return \Byteplus\Vedbm\Model\InstanceForDescribeExistDBInstancePriceInput[]
     */
     ...
     * Sets instances
     *
     * @param \Byteplus\Vedbm\Model\InstanceForDescribeExistDBInstancePriceInput[] $instances instances
     *
     * @return $this
     */
