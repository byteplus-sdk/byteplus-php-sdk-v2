...
class DescribeNetworkInterfacesRequest implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'status' => 'string',
        'subnet_id' => 'string',
        'tag_filters' => '\Byteplus\Vpc20250901\Model\TagFilterForDescribeNetworkInterfacesInput[]',
        'type' => 'string',
        'vpc_id' => 'string',
        'zone_id' => 'string'
    ];
     ...
     * Gets tag_filters
     *
     * @return \Byteplus\Vpc20250901\Model\TagFilterForDescribeNetworkInterfacesInput[]
     */
     ...
     * Sets tag_filters
     *
     * @param \Byteplus\Vpc20250901\Model\TagFilterForDescribeNetworkInterfacesInput[] $tag_filters tag_filters
     *
     * @return $this
     */
