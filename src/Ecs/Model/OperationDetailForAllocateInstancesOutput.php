...
class OperationDetailForAllocateInstancesOutput implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'error' => '\Byteplus\Ecs\Model\ErrorForAllocateInstancesOutput',
        'instance_ids' => 'string[]',
        'preorder_ids' => 'string[]',
        'zone_id' => 'string'
    ];
     ...
     * Gets error
     *
     * @return \Byteplus\Ecs\Model\ErrorForAllocateInstancesOutput
     */
     ...
     * Sets error
     *
     * @param \Byteplus\Ecs\Model\ErrorForAllocateInstancesOutput $error error
     *
     * @return $this
     */
