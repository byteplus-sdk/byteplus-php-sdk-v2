...
class IpsecConfigForCreateVpnConnectionInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'IpsecConfigForCreateVpnConnectionInput';
