...
class IkeConfigForDescribeVpnConnectionsOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'IkeConfigForDescribeVpnConnectionsOutput';
