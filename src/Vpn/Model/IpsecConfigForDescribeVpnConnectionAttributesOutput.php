...
class IpsecConfigForDescribeVpnConnectionAttributesOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'IpsecConfigForDescribeVpnConnectionAttributesOutput';
