...
class IkeConfigForModifyVpnConnectionAttributesInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'IkeConfigForModifyVpnConnectionAttributesInput';
