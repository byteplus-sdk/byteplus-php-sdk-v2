...
class IpsecConfigForModifyVpnConnectionAttributesInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'IpsecConfigForModifyVpnConnectionAttributesInput';
