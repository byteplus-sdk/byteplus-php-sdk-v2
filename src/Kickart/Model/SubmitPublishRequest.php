...
class SubmitPublishRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SubmitPublishRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['publish_id'] === null) {
            $invalidProperties[] = "'publish_id' can't be null";
        }
     ...
     * Sets publish_id
     *
     * @param int $publish_id publish_id
     *
     * @return $this
     */
