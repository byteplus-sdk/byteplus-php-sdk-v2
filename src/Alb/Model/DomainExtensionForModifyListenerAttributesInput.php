...
class DomainExtensionForModifyListenerAttributesInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DomainExtensionForModifyListenerAttributesInput';
