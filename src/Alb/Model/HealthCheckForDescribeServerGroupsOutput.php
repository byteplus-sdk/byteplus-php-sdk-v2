...
class HealthCheckForDescribeServerGroupsOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'HealthCheckForDescribeServerGroupsOutput';
