...
class ConvertRedirectConfigForModifyRulesInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ConvertRedirectConfigForModifyRulesInput';
