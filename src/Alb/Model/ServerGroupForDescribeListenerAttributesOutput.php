...
class ServerGroupForDescribeListenerAttributesOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ServerGroupForDescribeListenerAttributesOutput';
