...
class Ipv6EipBillingConfigForCreateLoadBalancerInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Ipv6EipBillingConfigForCreateLoadBalancerInput';
