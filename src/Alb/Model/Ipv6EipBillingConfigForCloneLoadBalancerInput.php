...
class Ipv6EipBillingConfigForCloneLoadBalancerInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Ipv6EipBillingConfigForCloneLoadBalancerInput';
