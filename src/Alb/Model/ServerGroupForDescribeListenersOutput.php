...
class ServerGroupForDescribeListenersOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ServerGroupForDescribeListenersOutput';
