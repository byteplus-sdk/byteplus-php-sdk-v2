...
class ListenerForDescribeCustomizedCfgAttributesOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ListenerForDescribeCustomizedCfgAttributesOutput';
