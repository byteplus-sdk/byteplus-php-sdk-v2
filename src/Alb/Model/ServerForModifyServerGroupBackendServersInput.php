...
class ServerForModifyServerGroupBackendServersInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ServerForModifyServerGroupBackendServersInput';
