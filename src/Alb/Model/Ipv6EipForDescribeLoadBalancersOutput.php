...
class Ipv6EipForDescribeLoadBalancersOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Ipv6EipForDescribeLoadBalancersOutput';
