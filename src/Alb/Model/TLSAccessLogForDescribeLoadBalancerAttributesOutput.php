...
class TLSAccessLogForDescribeLoadBalancerAttributesOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TLSAccessLogForDescribeLoadBalancerAttributesOutput';
