...
class HealthCheckForDescribeServerGroupAttributesOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'HealthCheckForDescribeServerGroupAttributesOutput';
