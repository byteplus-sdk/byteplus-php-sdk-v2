...
class Ipv6EipForDescribeLoadBalancerAttributesOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Ipv6EipForDescribeLoadBalancerAttributesOutput';
