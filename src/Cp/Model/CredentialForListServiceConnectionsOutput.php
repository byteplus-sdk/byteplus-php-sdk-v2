...
class CredentialForListServiceConnectionsOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CredentialForListServiceConnectionsOutput';
