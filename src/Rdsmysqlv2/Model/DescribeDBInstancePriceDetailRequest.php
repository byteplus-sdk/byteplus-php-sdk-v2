...
class DescribeDBInstancePriceDetailRequest implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'charge_type' => 'string',
        'node_info' => '\Byteplus\Rdsmysqlv2\Model\NodeInfoForDescribeDBInstancePriceDetailInput[]',
        'number' => 'int',
        'period' => 'int',
        'period_unit' => 'string',
        'proxy_node_custom' => '\Byteplus\Rdsmysqlv2\Model\ProxyNodeCustomForDescribeDBInstancePriceDetailInput',
        'storage_space' => 'int',
        'storage_type' => 'string'
    ];
     ...
     * Gets node_info
     *
     * @return \Byteplus\Rdsmysqlv2\Model\NodeInfoForDescribeDBInstancePriceDetailInput[]
     */
     ...
     * Sets node_info
     *
     * @param \Byteplus\Rdsmysqlv2\Model\NodeInfoForDescribeDBInstancePriceDetailInput[] $node_info node_info
     *
     * @return $this
     */
     ...
     *
     * @return \Byteplus\Rdsmysqlv2\Model\ProxyNodeCustomForDescribeDBInstancePriceDetailInput
     */
     ...
     *
     * @param \Byteplus\Rdsmysqlv2\Model\ProxyNodeCustomForDescribeDBInstancePriceDetailInput $proxy_node_custom proxy_node_custom
     *
     * @return $this
     */
