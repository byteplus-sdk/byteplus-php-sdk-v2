...
class DescribeDBInstanceParametersResponse implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'apply_param_template_info' => '\Byteplus\Rdsmysqlv2\Model\ApplyParamTemplateInfoForDescribeDBInstanceParametersOutput',
        'db_engine' => 'string',
        'db_engine_version' => 'string',
        'instance_id' => 'string',
        'parameter_count' => 'int',
        'parameters' => '\Byteplus\Rdsmysqlv2\Model\ParameterForDescribeDBInstanceParametersOutput[]'
    ];
     ...
     *
     * @return \Byteplus\Rdsmysqlv2\Model\ApplyParamTemplateInfoForDescribeDBInstanceParametersOutput
     */
     ...
     *
     * @param \Byteplus\Rdsmysqlv2\Model\ApplyParamTemplateInfoForDescribeDBInstanceParametersOutput $apply_param_template_info apply_param_template_info
     *
     * @return $this
     */
     ...
     * Gets parameters
     *
     * @return \Byteplus\Rdsmysqlv2\Model\ParameterForDescribeDBInstanceParametersOutput[]
     */
     ...
     * Sets parameters
     *
     * @param \Byteplus\Rdsmysqlv2\Model\ParameterForDescribeDBInstanceParametersOutput[] $parameters parameters
     *
     * @return $this
     */
