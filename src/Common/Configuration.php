...
use Byteplus\Common\Endpoint\Providers\DefaultEndpointProvider;
...
class Configuration
{
    ...
    protected $userAgent = 'byteplus-php-sdk-v2/1.0.5';
    ...
    {
        $report = 'PHP SDK (Byteplus\Common) Debug Report:' . PHP_EOL;
