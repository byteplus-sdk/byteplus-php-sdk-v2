...
namespace Byteplus\Common;

use GuzzleHttp\Client;
use GuzzleHttp\Exception\RequestException;
use GuzzleHttp\Exception\TransferException;
use Byteplus\Common\Auth\Providers\DefaultCredentialProvider;
use Byteplus\Common\Interceptor\InterceptorChain;
use Byteplus\Common\Interceptor\Interceptors\BuildRequestInterceptor;
use Byteplus\Common\Interceptor\Interceptors\Context;
use Byteplus\Common\Interceptor\Interceptors\DeserializedResponseInterceptor;
use Byteplus\Common\Interceptor\Interceptors\HttpLoggingInterceptor;
use Byteplus\Common\Interceptor\Interceptors\Request;
use Byteplus\Common\Interceptor\Interceptors\Response;
use Byteplus\Common\Interceptor\Interceptors\ResolveEndpointInterceptor;
use Byteplus\Common\Interceptor\Interceptors\SignRequestInterceptor;
